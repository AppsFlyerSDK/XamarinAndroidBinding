...
- AppsFlyer .NET Android Binding version: `v6.17.5` (.NET 8)</br>
- Built with AppsFlyer Android SDK: `v6.17.5`</br>
...
2. Update the AppsFlyer NuGet package to version 6.17.5 or later
